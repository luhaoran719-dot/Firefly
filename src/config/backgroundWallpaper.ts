...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop:[
			"assets/images/DesktopWallpaper/bg1.avif",
			"assets/images/DesktopWallpaper/bg2.avif",
			"assets/images/DesktopWallpaper/bg3.avif",
			"assets/images/DesktopWallpaper/bg4.avif",
			"assets/images/DesktopWallpaper/bg5.avif",
		],
